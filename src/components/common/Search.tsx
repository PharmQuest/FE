...
const Search: React.FC<SearchProps> = ({
  ...
  return (
    <div className="max-w-[920px] w-[80%] mx-auto flex items-center gap-4">
      {/* TextLabel */}
      {textLabel && (
      ...
      {/* 위치선택 */}
      <button className="flex items-center bg-white rounded-full px-4 py-3 text-body1-r text-gray-800 shadow-md">
        <img
