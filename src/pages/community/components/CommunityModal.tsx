...
const CommunityModal = ({isMobileModalOpen, setIsMobileModalOpen} : {isMobileModalOpen:boolean, setIsMobileModalOpen:Dispatch<SetStateAction<boolean>>}) => {
  ...
  return (
    ...
    <div
      className={`fixed top-0 w-screen h-screen bg-[#0000004D] backdrop-blur-[10px] transition-all duration-300 ease-out z-[999] ${isMobileModalOpen ? `opacity-100` : `opacity-0 pointer-events-none`}`}
